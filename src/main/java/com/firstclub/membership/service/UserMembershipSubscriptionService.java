...
@Service
public class UserMembershipSubscriptionService {
    private final UserMembershipRepository userMembershipRepository;
    private final MembershipService membershipService;
    private final MembershipMapper mapper;
    private final Logger logger = LoggerFactory.getLogger(UserMembershipSubscriptionService.class);
    public UserMembershipSubscriptionService(
    ...
    public UserMembership subscribe(String userId, Long membershipPlanId) {
        logger.info("[UserId: {}] Request received to subscribe membership:{}", userId, membershipPlanId);
    ...
    public MembershipTier evaluateTier(String userId) {
        return mapper.toDto(membershipService.determineTier(userId));
    }

    @Transactional
    public UserMembership cancel(String userId) {
        logger.info("[UserId: {}] Request received to cancel membership", userId);
